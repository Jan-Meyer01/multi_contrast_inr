...
def threshold_nifti(input_path, output_path):
    ...
    # Apply thresholding
    #thresholded_data = np.ones(image_data.shape).astype(np.int8)
...
def main():
    ...
    parser.add_argument("--identifier_in", required=True, help="Identifier for the input file")
    parser.add_argument("--identifier_out", required=True, help="Identifier for the output file")
